...
Within this framework, coherence is interpreted as a measure of functional coordination between distributed neural populations. The resulting matrices therefore characterise how patterns of neural communication reorganise across the cortex under different operating conditions.

These analyses are consistent with a transition toward a different dynamical operating regime in which functional coordination is redistributed rather than uniformly amplified or suppressed. Consequently, the figures describe changes in large-scale neural organisation without making direct claims regarding cognition, behaviour, or subjective experience.
